...
-- AddForeignKey
ALTER TABLE "User" ADD CONSTRAINT "User_pinned_post_id_fkey" FOREIGN KEY ("pinned_post_id") REFERENCES "Post"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Post" ADD CONSTRAINT "Post_quoted_post_id_fkey" FOREIGN KEY ("quoted_post_id") REFERENCES "Post"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Post" ADD CONSTRAINT "Post_in_reply_to_status_id_fkey" FOREIGN KEY ("in_reply_to_status_id") REFERENCES "Post"("id") ON DELETE SET NULL ON UPDATE CASCADE;
